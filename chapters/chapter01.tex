...
\begin{itemize}
  \item Tiến hành thu thập, gán nhãn và chuẩn hóa dữ liệu đầu vào tùy vào mô hình, sau đó tìm ra mô hình tối ưu nhất. Các dữ liệu hình ảnh được lưu vào cơ sở dữ liệu (thông tin, loại, vị trí). 
