...
\begin{table}[!ht]
	...
	\begin{tabular}{|l|r|r|r|}
		\cline{1-2}
		\textbf{Lớp}          & \textbf{Huấn luyện} & \textbf{Xác thực} & \textbf{Thử nghiệm}\\ \cline{1-2}
		\textbf{Nhựa - nilon} & 1656 & 618 & 235                \\ \cline{1-2}
		\textbf{Giấy}         & 1179 & 289 & 163                \\ \cline{1-2}
		\textbf{Kim loại}     & 660 & 150 & 49               \\ \cline{1-2}
		\textbf{Khác}         & 999 & 401 & 109               \\ \cline{1-2}
	\end{tabular}
