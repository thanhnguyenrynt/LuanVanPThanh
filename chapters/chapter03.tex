...
\begin{itemize}
	\item Bộ dữ liệu \#1 kết hợp của dữ liệu Taco, tự thu thập và bổ sung dữ liệu TrashNet để giải quyết vấn đề mất cân bằng dữ liệu. Tập dữ liệu dùng để thử nghiệm gồm hình ảnh các rác trong tự nhiên được lấy từ Taco và tự thu thập, thể hiện ở Bảng \ref{tab:datasettest}
...
\begin{table}[!ht]
	\centering
	\caption{Thuộc tính của tập dữ liệu dùng để thử nghiệm từ Taco và tự thu thập}
	\begin{tabular}{|l|l|}
	\cline{1-2}
	\textbf{Lớp}          & \textbf{Đối tượng}  \\ \cline{1-2}
	\textbf{Nhựa - nilon} & 235                 \\ \cline{1-2}
	\textbf{Giấy}         & 136                  \\ \cline{1-2}
	\textbf{Kim loại}     & 104                  \\ \cline{1-2}
	\textbf{Khác}         & 49                   \\ \cline{1-2}
	\end{tabular}
