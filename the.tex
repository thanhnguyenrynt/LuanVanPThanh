...
\newglossaryentry{bn}{name=BN, description={Batch Normalization}}
...
\newglossaryentry{itl}{name=IT, description={Inferior Temporal Gyrus}}
...
\newglossaryentry{v1}{name=V1, description={Primary Visual Cortex}}
\newglossaryentry{v2}{name=V2, description={Secondary Visual Cortex}}
\newglossaryentry{yolo}{name=YOLO, description={You Only Look Cnce}} 
...
% \chapter{\centering KẾT LUẬN VÀ ĐỀ XUẤT}
